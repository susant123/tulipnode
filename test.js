...
l.run("array dema", function () {
  //atoz page 123
  var a = [
    122.906, 126.5, 140.406, 174.0, 159.812, 170.0, 176.75, 175.531, 166.562,
    163.75, 170.5, 175.0, 184.75, 202.781,
  ];
  var b = [172.078, 168.5718, 170.2278, 173.494, 180.5297, 194.1428];
...
l.run("array tema", function () {
  ...
  var a = [
    122.906, 126.5, 140.406, 174.0, 159.812, 170.0, 176.75, 175.531, 166.562,
    163.75, 170.5, 175.0, 184.75, 202.781, 209.656, 201.312,
  ];
  var b = [182.8312, 198.5565, 209.476, 207.22];
...
l.run("array wilders", function () {
  //atoz page 366
  var a = [
    62.125, 61.125, 62.3438, 65.3125, 63.9688, 63.4375, 63, 63.7812, 63.4062,
    63.4062, 62.4375, 61.8438,
  ];
  var b = [62.975, 63.0675, 63.054, 63.1995, 63.2408, 63.2739, 63.1066, 62.854];
